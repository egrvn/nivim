...
export const homeContent = {
  hero: {
    ...
    note: "1000 ANSI · автофокус · Android 12 — включил и смотришь",
  ...
  story: {
    eyebrow: "История одного вечера",
    title: "От первого клика до чёрного экрана — одна минута",
    description:
      "Мы спроектировали VIDEL R1 вокруг обычного вечера: никаких инструкций, никакого ожидания. Только свет, звук и кадр, ради которого хочется присесть.",
    chapters: [
      {
        eyebrow: "18:42",
        title: "Возвращение домой",
        body: "Свет в прихожей, пальто на вешалке. Включаешь проектор жестом, пока ставишь чайник.",
      },
      {
        eyebrow: "18:43",
        title: "Комната становится сценой",
        body: "Автофокус сам ловит стену, звук разворачивается, фоном — твой плейлист.",
      },
      {
        eyebrow: "18:44",
        title: "И ты уже внутри",
        body: "Открываешь любимый сервис, садишься поудобнее — и понимаешь: вечер уже стоит того.",
      },
    ] as StoryChapter[],
  },
  problem: {
    ...
    description:
      "Мы десять лет смотрим одну и ту же диагональ, спорим из-за кабелей и ставим приставки стопками. Домашнее кино стало рутиной, а не ритуалом.",
    pairs: [
      {
        problem: "Экран всегда одного размера",
        solution: "VIDEL R1 разворачивает картинку до 150 дюймов — в любой комнате",
      },
      {
        problem: "Кабели и приставки множатся",
        solution: "Android 12 и Wi-Fi 6 уже внутри — ни одной лишней коробки",
      },
      {
        problem: "Каждый запуск — это ритуал настройки",
        solution: "Автофокус и автонастройка включаются одной кнопкой",
      },
    ] as ProblemSolutionPair[],
  },
  scenarios: {
  ...
  features: {
    ...
    description:
      "VIDEL R1 делает всё, чтобы ты думал не о настройках, а о моменте. Он умный, честный и создан, чтобы просто работать — день за днём, год за годом.",
    ...
    items: [
      ...
      {
        title: "Защищённая оптика и надёжность",
  ...
  value: {
    ...
    description: "VIDEL R1 даёт тот же эффект, что и проекторы за 45 000 ₽+, но без переплаты за логотип",
    highlights: [
      {
