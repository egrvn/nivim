...
export const homeContent = {
  ...
  testimonials: {
    ...
    items: [
      {
        name: "Алексей",
        role: "Домашний киносеанс каждую неделю",
        quote: "Поставили вечером в гостиной и буквально за пять минут всё заработало. Самое важное — проектор не требует отдельного ритуала запуска.",
      },
      {
        name: "Мария",
        role: "Сериалы, YouTube и спорт",
        quote: "Нравится, что не нужно городить приставки и кучу проводов. Вечером включили, выбрали фильм и просто смотрим.",
      },
      {
        name: "Егор",
        role: "Игры и фильмы на большом экране",
        quote: "Брал ради масштаба и атмосферы, а в итоге получил ещё и удобство. Автофокус и беспроводное подключение реально экономят время.",
      },
    ] as Testimonial[],
  },
  faq: {
