...
export function Footer({ ctaDescription, ctaHref, ctaLabel, ctaTitle, onOpenLead, showCta = false }: FooterProps) {
  ...
  return (
    <footer id="contacts" className="relative overflow-hidden border-t border-white/8 bg-[#090a13]">
      ...
      {showCta ? (
        <section className="mx-auto flex w-full max-w-[1220px] flex-col gap-8 px-4 pb-16 pt-20 sm:px-6 lg:flex-row lg:items-end lg:justify-between lg:px-8">
      ...
      <div className="mx-auto grid w-full max-w-[1220px] gap-12 px-4 pb-10 pt-14 sm:px-6 lg:grid-cols-[1.1fr,0.9fr,0.8fr] lg:px-8">
